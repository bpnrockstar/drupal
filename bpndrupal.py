...
|____/|_|  \___/|_| |_|\__,_|   |_|\___/ \___/|_|_|\_\_|\__|
          Coded by:- BIPIN RAI (@bpnrockstar)
'''
...
print ("\n\t**************************************************");
print ("\n\t*                bpn Drupal Toolkit            *");
print ("\n\t*            written By : BIPIN RAI            *");
print ("\n\t*    STUDENT AT THE OXFORD COLLEGE OF SCIENCE    *");
print ("\n\t*         Website :- www.tricksfans.com             *");
print ("\n\t**************************************************");
print ("\n\t i love to break the security of the system")
